...
bash "$ROOT/scripts/copy-bundled-qapps.sh" "$OUT/qualia_flutter.app/Contents/MacOS"
bash "$ROOT/scripts/copy-bundled-resources.sh" "$OUT/qualia_flutter.app/Contents/MacOS"
