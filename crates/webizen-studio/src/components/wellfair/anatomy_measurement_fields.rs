...
pub const MEASURE_FIELDS: &[MeasureField] = &[
    ...
    f(
        ...
        MeasureGroup::Feet,
        MeasureInput::Cm,
        "Fallback if left/right omitted.",
    ),
    f(
        "foot_left_mm",
        "Left foot length",
