...
pub async fn add_ledger_entry(
    ...
    js_sys::Reflect::set(
        &args,
        &"amountCents".into(),
        &wasm_bindgen::JsValue::from(amount_cents as f64),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"currency".into(),
        &wasm_bindgen::JsValue::from_str(currency),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    ...
    if let Some(uri) = attached_asset_uri {
        js_sys::Reflect::set(
            &args,
            &"attachedAssetUri".into(),
            &wasm_bindgen::JsValue::from_str(uri),
        )
        .map_err(|_| "failed to build invoke args".to_string())?;
    }
    ...
    let out = js
        .as_string()
        .ok_or_else(|| "ledger response was not JSON".to_string())?;
...
pub async fn fetch_ledger_balance(limit: usize) -> Result<BalanceReportDto, String> {
    ...
    let json = js
        .as_string()
        .ok_or_else(|| "balance response was not JSON".to_string())?;
...
pub async fn add_project(
    ...
    let out = js
        .as_string()
        .ok_or_else(|| "project response was not JSON".to_string())?;
    serde_json::from_str(&out).map_err(|e| e.to_string())
}
...
pub async fn add_contribution(
    ...
    js_sys::Reflect::set(
        &args,
        &"contributorDid".into(),
        &wasm_bindgen::JsValue::from_str(contributor_did),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    js_sys::Reflect::set(
        &args,
        &"effortMinutes".into(),
        &wasm_bindgen::JsValue::from(effort_minutes),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"capitalCents".into(),
        &wasm_bindgen::JsValue::from(capital_cents as u32),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"roiMultiplier".into(),
        &wasm_bindgen::JsValue::from_f64(roi_multiplier as f64),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"privacyLevel".into(),
        &wasm_bindgen::JsValue::from_str(privacy_level),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    if let Some(uri) = attached_asset_uri {
        js_sys::Reflect::set(
    ...
    let out = js
        .as_string()
        .ok_or_else(|| "contribution response was not JSON".to_string())?;
    serde_json::from_str(&out).map_err(|e| e.to_string())
}
...
pub async fn fetch_project_obligations(limit: usize) -> Result<Vec<ObligationDto>, String> {
    ...
    let json = js
        .as_string()
        .ok_or_else(|| "obligations response was not JSON".to_string())?;
    serde_json::from_str(&json).map_err(|e| e.to_string())
}
...
pub async fn add_credential(
    ...
    js_sys::Reflect::set(
        &args,
        &"issuerDid".into(),
        &wasm_bindgen::JsValue::from_str(issuer_did),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"subjectDid".into(),
        &wasm_bindgen::JsValue::from_str(subject_did),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"credentialType".into(),
        &wasm_bindgen::JsValue::from_str(credential_type),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"claimsJson".into(),
        &wasm_bindgen::JsValue::from_str(&claims_json),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    ...
    let out = js
        .as_string()
        .ok_or_else(|| "credential response was not JSON".to_string())?;
    serde_json::from_str(&out).map_err(|e| e.to_string())
}
...
pub async fn get_credential(record_id: &str) -> Result<Option<CredentialFullDto>, String> {
    ...
    let json = js
        .as_string()
        .ok_or_else(|| "credential response not JSON".to_string())?;
    if json.trim() == "null" {
        return Ok(None);
    }
...
pub async fn present_credential(
    ...
    js_sys::Reflect::set(
        &args,
        &"selectedKeysJson".into(),
        &wasm_bindgen::JsValue::from_str(&keys_json),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    ...
    let json = js
        .as_string()
        .ok_or_else(|| "presentation response not JSON".to_string())?;
    serde_json::from_str(&json).map_err(|e| e.to_string())
}
