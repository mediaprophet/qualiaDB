...
#[cfg(target_arch = "wasm32")]
pub(super) async fn invoke_str_arg(
    cmd: &str,
    key: &str,
    val: &str,
    ...
    let js = tauri_invoke(cmd, args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
...
pub async fn arm_dead_mans_switch(
    ...
    js_sys::Reflect::set(
        &args,
        &"commitmentHex".into(),
        &wasm_bindgen::JsValue::from_str(commitment_hex),
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"lapseAfterSecs".into(),
        &wasm_bindgen::JsValue::from_f64(lapse_after_secs as f64),
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"parties".into(),
        &serde_wasm_bindgen::to_value(&parties).map_err(|e| e.to_string())?,
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    js_sys::Reflect::set(
        &args,
        &"disposition".into(),
        &wasm_bindgen::JsValue::from_str(disposition),
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"dispositionParties".into(),
        &serde_wasm_bindgen::to_value(&disposition_parties).map_err(|e| e.to_string())?,
    )
    .map_err(|_| "args".to_string())?;
    tauri_invoke("wellfair_arm_dead_mans_switch", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    Ok(())
}
...
pub async fn attest_dead_mans(
    ...
    js_sys::Reflect::set(
        &args,
        &"partyDid".into(),
        &wasm_bindgen::JsValue::from_str(party_did),
    )
    .map_err(|_| "failed to build invoke args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    .map_err(|_| "failed to build invoke args".to_string())?;
    let js = tauri_invoke("wellfair_attest_dead_mans", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
...
#[cfg(target_arch = "wasm32")]
pub async fn enact_dead_mans_release(
    commitment_hex: &str,
    ...
    js_sys::Reflect::set(
        &args,
        &"partyKeys".into(),
        &serde_wasm_bindgen::to_value(&party_keys).map_err(|e| e.to_string())?,
    )
    .map_err(|_| "args".to_string())?;
    let js = tauri_invoke("wellfair_enact_dead_mans_release", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
...
#[cfg(target_arch = "wasm32")]
pub async fn split_dek_recovery(
    commitment_hex: &str,
    threshold: usize,
    parties: Vec<String>,
) -> Result<serde_json::Value, String> {
    ...
    .map_err(|_| "args".to_string())?;
    let js = tauri_invoke("wellfair_split_dek_recovery", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
...
#[cfg(target_arch = "wasm32")]
pub async fn reconstruct_and_release(
    commitment_hex: &str,
    ...
    js_sys::Reflect::set(
        &args,
        &"shares".into(),
        &serde_wasm_bindgen::to_value(&shares).map_err(|e| e.to_string())?,
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    .map_err(|_| "args".to_string())?;
    let js = tauri_invoke("wellfair_reconstruct_and_release", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
...
pub async fn set_peer_envelope_key(did: &str, pubkey_hex: &str) -> Result<(), String> {
    let args = js_sys::Object::new();
    js_sys::Reflect::set(&args, &"did".into(), &wasm_bindgen::JsValue::from_str(did))
        .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
        &"pubkeyHex".into(),
        &wasm_bindgen::JsValue::from_str(pubkey_hex),
    )
    .map_err(|_| "args".to_string())?;
    tauri_invoke("wellfair_set_peer_envelope_key", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    Ok(())
}
...
#[cfg(target_arch = "wasm32")]
pub async fn enact_dead_mans_release_via_peers(
    commitment_hex: &str,
) -> Result<serde_json::Value, String> {
    invoke_str_arg(
...
pub async fn arm_incapacity_switch(
    ...
    js_sys::Reflect::set(
        &args,
        &"principalDid".into(),
        &wasm_bindgen::JsValue::from_str(principal_did),
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    js_sys::Reflect::set(
        &args,
        &"advocateDid".into(),
        &wasm_bindgen::JsValue::from_str(advocate_did),
    )
    .map_err(|_| "args".to_string())?;
    js_sys::Reflect::set(
        &args,
    ...
    js_sys::Reflect::set(
        &args,
        &"requireOfficialInstrument".into(),
        &wasm_bindgen::JsValue::from_bool(require_official_instrument),
    )
    .map_err(|_| "args".to_string())?;
    tauri_invoke("wellfair_arm_incapacity_switch", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    Ok(())
}
...
pub async fn activate_incapacity(
    ...
    if let Some(instr) = official_instrument {
        js_sys::Reflect::set(
            &args,
            &"officialInstrument".into(),
            &wasm_bindgen::JsValue::from_str(&instr),
        )
        .map_err(|_| "failed to build invoke args".to_string())?;
    }
    let js = tauri_invoke("wellfair_activate_incapacity", args.into())
        .await
        .map_err(|e| format!("{e:?}"))?;
    let json = js
        .as_string()
