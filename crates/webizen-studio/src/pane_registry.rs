...
pub fn builtin_pane_definitions() -> Vec<PaneDefinition> {
    vec![
        ...
        PaneDefinition {
            ...
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ContextualWorkspace")),
        },
        PaneDefinition {
        ...
        PaneDefinition {
            ...
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:PhysicsSimulator")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ChemistryModeler")),
        },
        PaneDefinition {
            ...
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:OdeSolver")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:MatrixLab")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:StatisticalAnalysis")),
        },
        PaneDefinition {
            ...
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:BioinformaticsLab")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:QpuOptimizer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:QuantumDft")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:QaoaExplorer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:PortfolioAnalyzer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 6, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:RiskEngine")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Computational,
            default_w: 8, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:GbmSimulator")),
        },
        ...
        PaneDefinition {
            ...
            category: PaneCategory::Intelligence,
            default_w: 6, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:LoraManager")),
        },
        PaneDefinition {
        ...
        PaneDefinition {
            ...
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:AgreementsRights")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Governance,
            default_w: 6, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:KeyVault")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Governance,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ZkProofStudio")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Governance,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:DeonticLogicEditor")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Governance,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ShaclValidator")),
        },
        ...
        PaneDefinition {
            ...
            default_w: 10, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:SparqlExplorer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Knowledge,
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:N3LogicStudio")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Knowledge,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:RdfStarEditor")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Knowledge,
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:SolidLdpBrowser")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::Knowledge,
            default_w: 12, default_h: 8,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:NexusCanvas")),
        },
        ...
        PaneDefinition {
            ...
            category: PaneCategory::Data,
            default_w: 8, default_h: 5,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ProvenanceGraph")),
        },
        PaneDefinition {
        ...
        PaneDefinition {
            ...
            category: PaneCategory::DataDisplay,
            default_w: 6, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ClinicalRiskScorer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::DataDisplay,
            default_w: 8, default_h: 6,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:DicomViewer")),
        },
        PaneDefinition {
            ...
            category: PaneCategory::DataDisplay,
            default_w: 6, default_h: 4,
            rdf_type_hash: Some(qualia_core_db::q_hash("q42:ComorbidityAnalyzer")),
        },
    ]
}
