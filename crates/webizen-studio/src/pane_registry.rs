...
pub fn builtin_pane_definitions() -> Vec<PaneDefinition> {
    vec![
        ...
        PaneDefinition {
            ...
            element_tag: "directory".into(),
            icon: "person-rolodex".into(),
        ...
        PaneDefinition {
            component_id: "domains".into(),
            display_name: "Domains & Mail".into(),
            element_tag: "domains".into(),
            icon: "envelope-at".into(),
            category: PaneCategory::Network,
            default_w: 10,
            default_h: 8,
            rdf_type_hash: None,
        ...
        PaneDefinition {
            component_id: "connect".into(),
            display_name: "Connect (SocialWebNet)".into(),
            element_tag: "connect".into(),
            icon: "link-45deg".into(),
            category: PaneCategory::Network,
            default_w: 9,
            default_h: 8,
            rdf_type_hash: None,
        ...
        PaneDefinition {
            component_id: "connect-chat".into(),
            display_name: "Connect & Chat".into(),
            element_tag: "connect-chat".into(),
            icon: "chat-heart".into(),
            category: PaneCategory::Network,
            default_w: 6,
            default_h: 8,
            rdf_type_hash: None,
