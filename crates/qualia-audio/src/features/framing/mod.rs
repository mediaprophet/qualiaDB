...
//! - [`mod@overlap_add`] — sum pre-windowed frames back at a fixed hop (COLA).
//! - [`mod@istft`] — inverse STFT via IFFT + weighted overlap-add (WOLA), normalised
//!   by the analysis·synthesis window envelope for exact reconstruction.
//! - [`mod@griffin_lim`] — magnitude-only reconstruction by alternating projection.
//!
