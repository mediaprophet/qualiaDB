...
pub use qualia_core_db::specialized_libs::computer_vision::spatial::{
    ...
    class_score_to_sigma, cleanup_mesh_ir, closed_form_bar_stretch, detection_center_to_node_hint,
    detection_to_sigma, mesh_ir_to_export, mesh_ir_to_export_validated, mesh_ir_to_obj,
    mesh_ir_to_stl_binary, mesh_ir_triangles, print_readiness, promote_elasticity_preview,
    refuse_fea_unless_eligible, run_elasticity_preview_if_eligible, validate_mesh_ir,
    AnalysisDomain, BarStretchInput, BarStretchResult, MeshCleanupOptions, MeshIR,
