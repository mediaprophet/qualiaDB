...
static REGISTRY: &[CapabilityEntry] = &[
    ...
    // D2 learned
    cap!("D2.01", "D2", "detector_tracker", Partial, "grid detector + bounded tracker"),
    cap!("D2.02", "D2", "semantic_quins", Beyond, "epistemic observations"),
    cap!("D2.03", "D2", "qvwt_load", CompleteWithGate, "seed weights; licence for production"),
    ...
    // D3 biosense
    cap!("D3.01", "D3", "face_landmarks", Partial, "bbox face proxy + ROI; mesh weights gated"),
    ...
    cap!("D3.09", "D3", "liveness_pad", Partial, "texture variance challenge"),
    cap!("D3.10", "D3", "face_template_vault", Partial, "hash template; full crypto sanctuary gated"),
    ...
    cap!("D3.13", "D3", "affect_proposals", Present, "heuristic valence/arousal proposals + uncertainty"),
    cap!("D3.14", "D3", "au_lite", Partial, "temporal energy micro-events"),
