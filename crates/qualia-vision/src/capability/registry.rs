...
static REGISTRY: &[CapabilityEntry] = &[
    ...
    // D2 learned
    cap!("D2.01", "D2", "detector_tracker", CompleteWithGate, "YuNet MIT + YOLO-NAS Apache: PermissiveReady; WeightAbsent|AdapterMissing — vendor/vision/"),
    ...
    cap!("D2.05", "D2", "depth_mono", Missing, "AdapterMissing/weights TBD"),
    cap!("D2.06", "D2", "body_pose", CompleteWithGate, "MediaPipe Pose Apache PermissiveReady; WeightAbsent|AdapterMissing"),
    cap!("D2.07", "D2", "ocr", Missing, "product demand"),
    cap!("D2.08", "D2", "generative_image", Partial, "reference generator"),
    // D3 biosense
    cap!("D3.01", "D3", "face_landmarks", CompleteWithGate, "MediaPipe Face Apache-2.0 PermissiveReady; WeightAbsent|AdapterMissing — vendor/vision/face/"),
    ...
    cap!("D3.06", "D3", "eulerian_color_mag", Partial, "lite residual; excellence TODO-EVM1 (no weight)"),
    cap!("D3.07", "D3", "eulerian_motion_mag", Partial, "lite; excellence TODO-EVM1 (no weight)"),
    ...
    cap!("D3.10", "D3", "face_template_vault", CompleteWithGate, "SFace Apache-2.0 PermissiveReady; WeightAbsent|AdapterMissing — vendor/vision/face/sface"),
