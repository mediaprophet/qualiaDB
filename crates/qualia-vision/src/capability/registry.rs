...
static REGISTRY: &[CapabilityEntry] = &[
    ...
    cap!("D3.06", "D3", "eulerian_color_mag", Partial, "lite residual mag; excellence TODO-EVM1 (pyramid+bandpass+chroma)"),
    cap!("D3.07", "D3", "eulerian_motion_mag", Partial, "lite laplacian×temporal; excellence TODO-EVM1 multi-scale"),
