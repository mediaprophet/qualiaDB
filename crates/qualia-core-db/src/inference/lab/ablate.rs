...
use crate::llm_bench::{
    set_coop_gemv, set_ffn_fusion, set_kv_int8, set_resident_decode,
};
...
pub fn run_ablation_matrix(
    ...
    let cases: [(&str, bool, bool, bool, bool, InferenceMode); 6] = [
        ("baseline_resident", true, true, true, true, InferenceMode::Portable),
        ("no_coop", true, false, true, true, InferenceMode::Portable),
        ("no_resident", false, true, true, true, InferenceMode::Portable),
        ("kv_f32", true, true, true, false, InferenceMode::Portable),
        ("fast_verify", true, true, true, true, InferenceMode::FastVerify),
