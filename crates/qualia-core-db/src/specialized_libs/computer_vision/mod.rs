...
pub use spatial::{
    ...
    cleanup_mesh_ir, detection_center_to_node_hint, detection_to_sigma, mesh_ir_to_export,
    mesh_ir_to_export_validated, mesh_ir_to_obj, mesh_ir_to_stl_binary, mesh_ir_triangles,
    print_readiness, refuse_fea_unless_eligible, validate_mesh_ir, AnalysisDomain, MeshCleanupOptions,
    MeshIR, MeshQualityReport, MeshValidationReport, MeshValidationStatus, NodeHint, PrintReadiness,
