...
pub fn lda_correlation_vwn(rho: f64) -> (f64, f64) {
    ...
    let r_s = Dual::new(
        (3.0 / (4.0 * core::f64::consts::PI * rho)).powf(1.0 / 3.0),
        -1.0 / (3.0 * rho) * (3.0 / (4.0 * core::f64::consts::PI * rho)).powf(1.0 / 3.0),
    );
...
mod tests {
    ...
    fn test_lda_exchange() {
        ...
        // vx = 4/3 * ex
        let expected_ex =
            -0.75 * (3.0 / core::f64::consts::PI).powf(1.0 / 3.0) * rho.powf(1.0 / 3.0);
