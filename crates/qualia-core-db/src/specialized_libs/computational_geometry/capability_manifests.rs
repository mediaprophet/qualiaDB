...
pub const GEOMETRY_OP_MANIFESTS: &[OpManifest] = &[
    ...
    OpManifest {
        op: "corefine_3d",
        description: "3D mesh co-refinement: split two triangle meshes along their intersection curves for compatible boundaries. Uses BVH broad phase + tri_tri_intersect_3 narrow phase. Intersection points inserted into both meshes, triangles split into sub-triangles.",
        backends: &[Backend::Scalar, Backend::Exact],
        determinism: DeterminismClass::BitExact,
        limits: ResourceLimits {
            max_input_points: 50_000,
