...
pub fn verify_selector_contract(a: &Tensor10D, b: &Tensor10D) -> bool {
    ...
    // Perturb q.
    let a_q = Tensor10D::new(a.q + 1.0, a.v, a.w, a.x, a.y, a.z, a.t, a.alpha, a.mu, a.sigma);
    let d_q = axis_honest_distance(&a_q, b);

    // Perturb w.
    let a_w = Tensor10D::new(a.q, a.v, a.w + 1.0, a.x, a.y, a.z, a.t, a.alpha, a.mu, a.sigma);
...
pub fn verify_axis_honesty(a: &Tensor10D, b: &Tensor10D) -> bool {
    ...
    // Perturb α.
    let a_alpha = Tensor10D::new(a.q, a.v, a.w, a.x, a.y, a.z, a.t, a.alpha + 1.0, a.mu, a.sigma);
...
mod tests {
    ...
    fn radius_query_returns_points_in_range() {
        ...
        let mut results = vec![NnEntry { index: 0, distance: 0.0 }; pts.len()];
    ...
    fn knn_query_returns_k_nearest() {
        ...
        let query = make_point(2.0, 2.0, 0.0);
        let k = 3;
        let mut results = vec![NnEntry { index: 0, distance: 0.0 }; k];
    ...
    fn radius_query_matches_brute_force() {
        ...
        let mut results1 = vec![NnEntry { index: 0, distance: 0.0 }; pts.len()];
        let mut results2 = vec![NnEntry { index: 0, distance: 0.0 }; pts.len()];
        ...
        for i in 0..n1 {
            assert_eq!(results1[i].index, results2[i].index, "index mismatch at {}", i);
            assert!((results1[i].distance - results2[i].distance).abs() < 1e-10,
    ...
    fn selector_contract_q_w_v_excluded() {
        ...
        assert!(verify_selector_contract(&a, &b),
    ...
    fn axis_honesty_v0_includes_spectral() {
        let a = make_point(0.0, 0.0, 0.0);
        let b = make_point(1.0, 0.0, 0.0);
        assert!(verify_axis_honesty(&a, &b),
    ...
    fn radius_query_determinism() {
        ...
        let mut r1 = vec![NnEntry { index: 0, distance: 0.0 }; pts.len()];
        let mut r2 = vec![NnEntry { index: 0, distance: 0.0 }; pts.len()];
    ...
    fn knn_query_determinism() {
        ...
        let mut r1 = vec![NnEntry { index: 0, distance: 0.0 }; 5];
        let mut r2 = vec![NnEntry { index: 0, distance: 0.0 }; 5];
    ...
    fn empty_point_cloud_errors() {
        ...
        let query = make_point(0.0, 0.0, 0.0);
        let mut results = vec![NnEntry { index: 0, distance: 0.0 }; 1];
    ...
    fn knn_fewer_than_k() {
        ...
        let mut results = vec![NnEntry { index: 0, distance: 0.0 }; 5];
