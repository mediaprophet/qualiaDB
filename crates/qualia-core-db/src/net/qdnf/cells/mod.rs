...
//! fairness. [`af_xdp`] never opens a zero-copy NIC on this Linux userspace.
...
pub use scaling::{
    fair_grant, idle_energy_measured, idle_joules, numa_measured, numa_node, rss_bytes,
    rss_measured, HardwareObservation, ScaleHost, MAX_SCALE_CELLS,
};
