...
impl NetworkDisclosureRegistry {
    ...
    pub fn register_egress(
        ...
        let entry = self.allowed_endpoints.entry(adapter_id.to_string()).or_insert_with(Vec::new);
...
mod tests {
    ...
    fn test_disclosure_registry() {
        ...
        // Prefix match
        assert!(registry.check_egress_consent("dem_adapter", "https://elevation.example.com/tile/1/2/3.tif"));
