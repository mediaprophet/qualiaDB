...
// --- services/ category (moved from crate root; paths preserved) ---
pub mod services;
...
// --- medical/ category (moved from crate root; paths preserved) ---
pub mod medical;
#[cfg(not(target_arch = "wasm32"))]
...
// --- query/ category (moved from crate root; paths preserved) ---
pub mod query;
...
// --- platform/ category (moved from crate root; paths preserved) ---
pub mod platform;
...
// --- inference/ category (moved from crate root; paths preserved) ---
pub mod inference;
...
#[cfg(any(not(target_arch = "wasm32"), feature = "wasm-llm"))]
pub mod lora;
// --- q42/ category (moved from crate root; paths preserved) ---
pub mod q42;
#[cfg(any(not(target_arch = "wasm32"), feature = "wasm-llm"))]
...
// --- extensions/ category (moved from crate root; paths preserved) ---
pub mod extensions;
...
pub mod modalities;
// --- identity/ category (moved from crate root; paths preserved) ---
pub mod identity;
...
pub mod gpu_context;
pub mod shaders;
// --- foundation/ category (moved from crate root; paths preserved) ---
pub mod foundation;
...
// --- net/ category (moved from crate root; paths preserved) ---
pub mod net;
#[cfg(not(target_arch = "wasm32"))]
