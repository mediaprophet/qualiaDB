...
// [WASM] Subgroup-reduction twins (coop_fused_ffn_sg, coop_fused_ffn_mr) stripped —
// naga rejects subgroupAdd without `enable subgroups;` and WebGPU/WASM doesn't support
// subgroups. Only fused_ffn_expansion, coop_fused_ffn_expansion, and coop_fused_ffn_warp
// are used on WASM. See the original (non-wasm) fused_ffn.wgsl for the subgroup variants.
