...
use qualia_core_db::sparql_library::parsers::json_parser::{JsonMappingProfile, JsonFieldMapping, JsonDatatype, parse_json_to_quins};
...
pub fn stream_json_to_quins(json_path: &str, output_path: &str, profile: &super::mapper::MappingProfile) {
    ...
    let core_profile = JsonMappingProfile {
        ...
        fields: profile.fields.iter().map(|f| JsonFieldMapping {
