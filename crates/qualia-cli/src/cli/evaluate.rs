...
pub enum EvaluateModality {
    ...
    Ltl {
        dataset: PathBuf,
        #[arg(long)] formula_type: String,
        #[arg(long, default_value = "0")] hash_a: u64,
        #[arg(long, default_value = "0")] hash_b: u64,
    },
    Asp {
        dataset: PathBuf,
        #[arg(long, default_value = "0")] base_index: usize,
    },
    Dl {
        dataset: PathBuf,
        #[arg(long)] sub_class: u64,
        #[arg(long)] super_class: u64,
    },
    Probabilistic {
        #[arg(long)] weight: f32,
        #[arg(long)] threshold: f32,
    },
    LinearLogic {
        dataset: PathBuf,
        #[arg(long, default_value = "0")] quin_index: usize,
    },
    Dialectical {
        dataset: PathBuf,
        #[arg(long)] var1: u64,
    ...
    GraphTopology {
        dataset: PathBuf,
        #[arg(long, default_value = "0")] context: u64,
    },
    Argumentation {
        #[arg(long)] demo: bool,
