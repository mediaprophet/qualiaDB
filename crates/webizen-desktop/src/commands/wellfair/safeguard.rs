...
// â”€â”€ Safeguard switches (ADR 0011 D6/D7): dead-man + incapacity â”€â”€
...
/// Enact a dead-man switch if triggerable â€” returns the disposition (or null).
#[command]
