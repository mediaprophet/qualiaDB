...
impl WgslPipelineKind {
    ...
    pub fn sample_source(&self) -> &'static str {
        match self {
            Self::CyberGlass => r#"// cyber_glass.wgsl
struct GlassParams {
    blur_radius: f32,
...
"#,
            Self::GraphPhysics => r#"// graph_physics.wgsl
...
"#,
            Self::WireParticles => r#"// wire_particles.wgsl
...
"#,
            Self::EpistemicAura => r#"// epistemic_aura.wgsl
@fragment
...
"#,
            Self::ManifoldGrid => r#"// manifold_grid.wgsl
@fragment
...
"#,
            Self::SurfaceMesh10d => r#"// surface_mesh_10d.wgsl
@vertex
...
impl WgslPipelineDesc {
    pub fn all() -> Vec<Self> {
        vec![
            Self { kind: WgslPipelineKind::CyberGlass, workgroup_x: 16, estimated_draw_call_cost_us: 180, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::GraphPhysics, workgroup_x: 256, estimated_draw_call_cost_us: 420, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::WireParticles, workgroup_x: 64, estimated_draw_call_cost_us: 90, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::EpistemicAura, workgroup_x: 1, estimated_draw_call_cost_us: 45, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::ManifoldGrid, workgroup_x: 1, estimated_draw_call_cost_us: 30, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::AffineMorph, workgroup_x: 64, estimated_draw_call_cost_us: 120, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::DicomVolumeRaymarch, workgroup_x: 16, estimated_draw_call_cost_us: 850, is_certified_zero_alloc: true },
            Self { kind: WgslPipelineKind::SurfaceMesh10d, workgroup_x: 64, estimated_draw_call_cost_us: 340, is_certified_zero_alloc: true },
        ]
    }
}
...
pub fn build_shader_pipeline_view(document: &Document) -> Element {
    ...
    meta.set_text_content(Some(&format!("Active Pipelines: {} \u{00B7} Backend: Vulkan / WebGPU \u{00B7} Zero-Alloc: \u{2713}", pipelines.len())));
    ...
    for p in &pipelines {
        ...
        name_el.style().set_css_text("font-weight: 700; font-family: var(--font-mono); font-size: 12px; color: #38bdf8;");
        ...
        desc_el.style().set_css_text("font-size: 11px; color: #cbd5e1;");
