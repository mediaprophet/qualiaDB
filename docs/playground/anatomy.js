...
import { ensureCanvasBackingStore, loadQualiaPortal } from "../js/qualia-shell.js?v=0.0.35-mobile-recovery4";
import {
  getBrowserCapabilityReceipt,
  recordBackendDeviceOutcome,
} from "../js/browser-capability.js?v=0.0.35-mobile-recovery4";
