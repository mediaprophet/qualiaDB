...
**Status:** implemented · focused tests passed · accepted under Gate A close 2026-09-06  
...
## Not claimed (accepted Gate A residuals)
...
Gate A closed 2026-09-06 — `AST-*` may start under its own packets.
