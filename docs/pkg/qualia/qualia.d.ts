...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__hfbfb57c032203f54: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h2189f2ed44716dcd: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h2189f2ed44716dcd_2: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h2189f2ed44716dcd_3: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h10a4ed7b707a1abb: (a: number, b: number, c: any, d: any) => void;
