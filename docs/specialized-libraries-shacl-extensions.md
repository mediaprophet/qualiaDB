...
- `PolynomialSolveConfiguration` - Polynomial root-finding (degree ≤ 256; quadratic_closed_form / durand_kerner / companion) *(added 0.0.33)*
- `SvdConfiguration` - Singular value decomposition parameters *(added 0.0.33)*
- `DeterminantConfiguration` - Determinant computation (lu / cofactor) *(added 0.0.33)*
...
### 1b. Symbolic Algebra (CAS) Library *(added 0.0.33)*
