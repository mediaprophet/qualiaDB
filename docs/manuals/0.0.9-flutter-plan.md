...
## 9. Phase 6 — Sensitivity & Block Inspector (Sprint 5B)

### 9.1 Sensitivity rendering
...
### 9.2 Block Inspector (power user / dev)
...
## 12. Engine Contracts (Do Not Violate in UI Work)
...
5. Identify sprint (4A–5B) from Section 10.
