...
Here are the direct answers to your architectural questions regarding the implementation of SPARQL-Star within the current QualiaDB 0.0.15-dev codebase.
...
# SPARQL-Star Implementation Status - QualiaDB 0.0.15-dev
