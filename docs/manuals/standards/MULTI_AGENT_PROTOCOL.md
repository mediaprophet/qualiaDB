...
**Version:** 1.0.0
**Target Environment:** QualiaDB `0.0.33` _(draft — Sentinel VM & Swarm Daemon; coordination ISA 0x70–0x72 implemented, see §5; remaining parts proposed)_
...
>
> **Implementation status (0.0.33).** Implemented and unit-tested in
