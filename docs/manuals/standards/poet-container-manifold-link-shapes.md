# Container · Manifold · Link · twins (v0)
...
| `q42:layout` / `q42:stage` / `q42:timeline` | 1:1 twins |
...
Every shipped surface has all three. Reduced-motion: same beats, shorter/crossfade.
