...
- [ ] **Ramifications of Works**: Define the strict legal and computational consequences when an actor utilizes an inference from the Commons. How are these ramifications enforced by the Webizen VM?
